...
const databaseConnectionsCredentialsKey = process.env.DATABASE_CONNECTIONS_CREDENTIALS_KEY
...
const decryptCredentials = (
  ...
  const decryptedCredentials = CryptoJS.AES.decrypt(
    encryptedCredentials, organizationId + organizationCreatedAt + databaseConnectionsCredentialsKey
